    ...
    <?php foreach ($reviews as $review): ?>
      <article class="panel review-card">
        ...
        <form class="review-form" method="post" action="/projects/review">
          ...
          <label class="field"><span>Decisão</span><select name="decision" required><option value="aprovado">Aprovar e enviar ao comercial</option><option value="ajustes">Solicitar ajustes</option><option value="reprovado">Reprovar</option></select></label>
          ...
          <label class="field field-full"><span>Observações</span><textarea name="notes" rows="3"><?= e($review['observacoes'] ?? '') ?></textarea></label>
