...
$cssVersion = (string) (@filemtime('/var/www/app/public/assets/css/admin.css') ?: 1);
$jsVersion = (string) (@filemtime('/var/www/app/public/assets/js/admin.js') ?: 1);
?>
<!doctype html>
...
<head>
  ...
  <script defer src="/assets/js/admin.js?v=<?= e($jsVersion) ?>"></script>
</head>
